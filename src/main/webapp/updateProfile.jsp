...
<title>update Form by nawaz</title>
			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						...
						<form method="post" action="${pageContext.request.contextPath}/registra" class="register-form"
							id="register-form">
							<div class="form-group">
								<label for="name"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="text" name="name" id="name" value="${param.sename }" />
							</div>
							<div class="form-group">
